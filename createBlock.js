...
let defaultExtensions = ['tsx', 'scss']; // расширения по умолчанию
  ...
  mkdirp(dirPath, function (err) {
    ...
    // Нет ошибки, поехали!
      ...
      extensions.forEach(function (extention) {
        ...
        // Если это LESS
        if (extention == 'scss') {
          filePath = dirPath + blockName + '.module.' + extention;
          styleFileImport = "@import './src/blocks/" + blockName + '/' + blockName + ".module.scss';";
          fileContent =
            '// Для импорта в диспетчер подключений: ' + styleFileImport + '\n\n\n.' + blockName + ' {\n  \n}\n';
